...
- 보물 보상은 탭 2배(15초), 탭 10배(5초), 자동 생산 3배(10초, 연구소 필요), 행운의 쿠키 중 하나다.
- 행운의 쿠키 보상은 현재 탭·자동 생산 기준이며, 적금 금액에 따른 추가 보상이 붙는다.
...
- 적금은 현재 포인트의 절반을 넣는다. 원금은 환생 후에도 남고, 행운의 쿠키 추가 보상을 키운다.
...
| 적금 쿠키 보상 | `baseCookieReward`, `savingsCookieBonus` |
